...
polka() {
  case "$1" in 
    ...
    "dir")
      cd /Users/arturgudiev/Programming/Job/Polka ;;

    "dirb")
      cd /Users/arturgudiev/Programming/Job/Polka/polka_sharp/ ;;

    "dirf")
      cd /Users/arturgudiev/Programming/Job/Polka/polka_ui ;;
